...
#define NOISE_DENSITY 50.0 // Vertical noise frequency; higher magnitude makes noise pattern denser vertically.
#define NOISE_INTENSITY 3.35 // Overall noise strength; higher increases noise visibility.
#define NOISE_SPREAD 20.0 // Noise spread; higher values make noise pattern broader.
...
void main() {
    ...
    color += drawHarmonicWavyStripe(-0.1, 0.5, vec3(0.81, 0.76, 0.66), 0, 0.0, 2, 0.07); // Dark purple-brown
    color += drawHarmonicWavyStripe(0.5, 1.5, vec3(0.58, 0.49, 0.32), 2, 0.07, 2, 0.03); // Dark reddish-brown
